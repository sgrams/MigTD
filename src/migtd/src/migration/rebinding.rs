...
async fn rebinding_old_prepare(
    ...
    // Use local event log for backward compatibility with the current RATLS flow.
    // TODO(ghci_20260214): Update RATLS cert extension to remove init_event_log dependency
